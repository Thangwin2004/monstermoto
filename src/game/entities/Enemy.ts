...
export class Enemy extends Container {
    ...
    reset(def: EnemyDefinition, hpScale: number = 1) {
        ...
        // Setup drop shadow
        this.shadow.clear();
        this.shadow.ellipse(0, def.radius * 0.7, def.radius * 0.9, def.radius * 0.4)
        ...
        switch (def.id) {
            case 'runner': {
                ...
                g.poly([-r * 0.5, -r * 0.5, -r * 0.2, -r * 0.8, -r * 0.8, -r * 1.4])
                    .fill(0x18181b).stroke({ color: 0x000000, width: 2 });
                g.poly([r * 0.5, -r * 0.5, r * 0.2, -r * 0.8, r * 0.8, -r * 1.4])
                    .fill(0x18181b).stroke({ color: 0x000000, width: 2 });

                // Glowing Yellow Slit Eyes
                g.ellipse(-r * 0.35, -r * 0.1, r * 0.22, r * 0.12).fill(0xfacc15).stroke({ color: 0x000000, width: 1.5 });
                g.ellipse(r * 0.35, -r * 0.1, r * 0.22, r * 0.12).fill(0xfacc15).stroke({ color: 0x000000, width: 1.5 });
                g.circle(-r * 0.35, -r * 0.1, r * 0.08).fill(0x000000);
                g.circle(r * 0.35, -r * 0.1, r * 0.08).fill(0x000000);

                // Sharp fanged maw
                g.poly([-r * 0.4, r * 0.3, 0, r * 0.55, r * 0.4, r * 0.3]).fill(0x000000);
                g.poly([-r * 0.25, r * 0.3, -r * 0.15, r * 0.3, -r * 0.2, r * 0.45]).fill(0xffffff);
                g.poly([r * 0.15, r * 0.3, r * 0.25, r * 0.3, r * 0.2, r * 0.45]).fill(0xffffff);
                break;
            }
            ...
            case 'tank': {
                ...
                g.poly([-r * 1.2, -r * 0.2, -r * 0.7, -r * 0.8, -r * 0.7, r * 0.4])
                    .fill(0x71717a).stroke({ color: 0x000000, width: 2.5 });
                g.poly([r * 1.2, -r * 0.2, r * 0.7, -r * 0.8, r * 0.7, r * 0.4])
                    .fill(0x71717a).stroke({ color: 0x000000, width: 2.5 });

                // 2 Huge Front Iron Horns
                g.poly([-r * 0.6, -r * 0.7, -r * 0.2, -r * 0.9, -r * 0.7, -r * 1.5]).fill(0xd4d4d8).stroke({ color: 0x000000, width: 2 });
                g.poly([r * 0.6, -r * 0.7, r * 0.2, -r * 0.9, r * 0.7, -r * 1.5]).fill(0xd4d4d8).stroke({ color: 0x000000, width: 2 });
                ...
                g.roundRect(-r * 0.5, r * 0.25, r * 1.0, r * 0.45, 4).fill(0x52525b).stroke({ color: 0x000000, width: 2 });
            ...
            case 'spitter': {
                ...
                // 4 Spidery Legs
                g.poly([-r * 0.8, -r * 0.3, -r * 1.3, -r * 0.7, -r * 1.1, -r * 0.1]).fill(0x14532d);
                g.poly([r * 0.8, -r * 0.3, r * 1.3, -r * 0.7, r * 1.1, -r * 0.1]).fill(0x14532d);
                g.poly([-r * 0.8, r * 0.3, -r * 1.3, r * 0.7, -r * 1.1, r * 0.1]).fill(0x14532d);
                g.poly([r * 0.8, r * 0.3, r * 1.3, r * 0.7, r * 1.1, r * 0.1]).fill(0x14532d);
                ...
                // Curved Stinger Tail
                g.poly([0, r * 0.6, -r * 0.3, r * 1.2, 0, r * 1.5, r * 0.2, r * 1.1]).fill(0x166534).stroke({ color: 0x000000, width: 2 });
            ...
            case 'jumper': {
                ...
                // Jagged Bat Wings
                g.poly([-r * 0.5, 0, -r * 1.4, -r * 0.9, -r * 1.2, r * 0.3, -r * 0.6, r * 0.3])
                    .fill(0x581c87).stroke({ color: 0x000000, width: 2.5 });
                g.poly([r * 0.5, 0, r * 1.4, -r * 0.9, r * 1.2, r * 0.3, r * 0.6, r * 0.3])
                    .fill(0x581c87).stroke({ color: 0x000000, width: 2.5 });
                ...
                // Spring Legs
                g.poly([-r * 0.5, r * 0.6, -r * 0.8, r * 1.2, -r * 0.3, r * 1.3]).fill(0x4c1d95).stroke({ color: 0x000000, width: 2 });
                g.poly([r * 0.5, r * 0.6, r * 0.8, r * 1.2, r * 0.3, r * 1.3]).fill(0x4c1d95).stroke({ color: 0x000000, width: 2 });

                // Glowing Neon Violet Eyes
                g.circle(-r * 0.3, -r * 0.15, r * 0.18).fill(0xf0abfc).stroke({ color: 0x000000, width: 1.5 });
                g.circle(r * 0.3, -r * 0.15, r * 0.18).fill(0xf0abfc).stroke({ color: 0x000000, width: 1.5 });
                break;
            }
            ...
            case 'swarm': {
                ...
                // Front Pincers
                g.poly([-r * 0.5, -r * 0.5, -r * 0.7, -r * 1.1, -r * 0.2, -r * 0.8]).fill(0xf59e0b);
                g.poly([r * 0.5, -r * 0.5, r * 0.7, -r * 1.1, r * 0.2, -r * 0.8]).fill(0xf59e0b);
                // Eyes
            ...
            case 'bomber': {
                ...
                g.rect(-r * 0.6, r * 0.1, r * 1.2, r * 0.25).fill(0xdc2626).stroke({ color: 0x000000, width: 1.5 });
                g.rect(-r * 0.4, r * 0.35, r * 0.8, r * 0.2).fill(0xdc2626).stroke({ color: 0x000000, width: 1.5 });

                // Burning Sparkling Fuse on Top
                g.poly([0, -r * 0.8, r * 0.3, -r * 1.2, 0, -r * 1.4]).stroke({ color: 0x71717a, width: 3 });
                // Sparks
                g.circle(0, -r * 1.4, 4.5).fill(0xfacc15);
                g.circle(0, -r * 1.4, 2.5).fill(0xffffff);

                // Manic Glowing Eyes
                g.circle(-r * 0.35, -r * 0.25, r * 0.2).fill(0xffffff).stroke({ color: 0x000000, width: 1.5 });
                g.circle(r * 0.35, -r * 0.25, r * 0.2).fill(0xffffff).stroke({ color: 0x000000, width: 1.5 });
            ...
            case 'colossus': {
                ...
                g.poly([0, -r * 0.3, -r * 0.4, r * 0.3, 0, r * 0.6, r * 0.4, r * 0.3]).fill(0xea580c);
                g.circle(0, 0, r * 0.25).fill(0xfacc15);

                // 4 Colossal Jagged Demonic Horns
                g.poly([-r * 0.7, -r * 0.7, -r * 0.3, -r * 1.0, -r * 1.0, -r * 1.8]).fill(0x52525b).stroke({ color: 0x000000, width: 3 });
                g.poly([r * 0.7, -r * 0.7, r * 0.3, -r * 1.0, r * 1.0, -r * 1.8]).fill(0x52525b).stroke({ color: 0x000000, width: 3 });
                // Red Blood-Tipped Horns
                g.poly([-r * 0.85, -r * 1.5, -r * 0.7, -r * 1.3, -r * 1.0, -r * 1.8]).fill(0xdc2626);
                g.poly([r * 0.85, -r * 1.5, r * 0.7, -r * 1.3, r * 1.0, -r * 1.8]).fill(0xdc2626);

                // Glowing Demonic Eyes
                g.ellipse(-r * 0.4, -r * 0.4, r * 0.22, r * 0.12).fill(0xf97316).stroke({ color: 0x000000, width: 2 });
                g.ellipse(r * 0.4, -r * 0.4, r * 0.22, r * 0.12).fill(0xf97316).stroke({ color: 0x000000, width: 2 });
                break;
            }
            ...
            case 'stalker': {
                ...
                g.poly([-r * 0.6, -r * 0.2, -r * 1.5, -r * 0.8, -r * 1.2, r * 0.5]).fill(0xa855f7).stroke({ color: 0x000000, width: 2 });
                g.poly([r * 0.6, -r * 0.2, r * 1.5, -r * 0.8, r * 1.2, r * 0.5]).fill(0xa855f7).stroke({ color: 0x000000, width: 2 });
            ...
            case 'acid_queen': {
                ...
                // Crown of Spikes
                g.poly([-r * 0.8, -r * 0.6, 0, -r * 1.4, r * 0.8, -r * 0.6]).fill(0x064e3b).stroke({ color: 0x000000, width: 3 });
    ...
    hasBurn(): boolean { return this.burnTimer > 0; }
    hasShock(): boolean { return this.shockTimer > 0; }
    ...
    updateStatusEffects(dtSec: number) {
        ...
        if (this.burnTimer > 0) {
            ...
            const r = this.radius;
            this.statusGlow.circle(0, 0, r + 8)
                .fill({ color: 0xff3b30, alpha: 0.25 });

            for (let i = 0; i < 5; i++) {
                const angle = (Math.PI * 2 / 5) * i + this.animTime * 4;
                const fx = Math.cos(angle) * (r + 4);
                const fy = Math.sin(angle) * (r + 4) - Math.abs(Math.sin(this.animTime * 12 + i)) * 12;
                this.statusGlow.circle(fx, fy, 6 + Math.sin(this.animTime * 10 + i) * 3)
            ...
            this.statusGlow.circle(0, 0, r + 10)
                .stroke({ color: 0x00f0ff, width: 3, alpha: 0.85 });
            this.statusGlow.circle(0, 0, r + 14)
    ...
    private updateHpBar() {
        ...
        // Shadow
        this.hpBar.roundRect(-barW / 2 + 1, barY + 1, barW, barH, 3)
            .fill({ color: 0x000000, alpha: 0.4 });
        // Bg
        this.hpBar.roundRect(-barW / 2, barY, barW, barH, 3)
            .fill(0x1a1a24)
            .stroke({ color: 0xffffff, width: 1 });
        // Fill
        const fillW = Math.max(2, (barW - 2) * ratio);
        const fillColor = ratio < 0.3 ? 0xff3b30 : (ratio < 0.6 ? 0xffcc00 : 0x34c759);
        this.hpBar.roundRect(-barW / 2 + 1, barY + 1, fillW, barH - 2, 2)
            .fill(fillColor);
    }
