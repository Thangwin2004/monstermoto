export type UpgradeRarity = 'common' | 'rare' | 'epic' | 'legendary' | 'corrupted';
...
export const UpgradeDefinitions: UpgradeDefinition[] = [
    ...
    // ── Lên Sao / Thêm Module ──
    {
        ...
        description: 'Tăng +1 Sao ⭐ cho Súng Máy: +50% Sát thương, +20% Tốc bắn & thêm đạn.',
        effects: [{ type: 'upgrade_module_star', value: 1, moduleId: 'machine_gun' }],
    },
    {
        ...
        requireTags: ['fire'],
        description: 'Tăng +1 Sao ⭐ cho Phun Lửa: +50% Sát thương & mở rộng vòm lửa.',
        effects: [{ type: 'upgrade_module_star', value: 1, moduleId: 'flamethrower' }],
    },
    {
        id: 'star_tesla',
        name: '⭐ Nâng Cấp Tesla',
        ...
        description: 'Tăng +1 Sao ⭐ cho Tesla: +50% Sát thương & giật thêm +1 mục tiêu.',
    ...
    },
    {
        ...
        requireTags: ['defense'],
        description: 'Tăng +1 Sao ⭐ cho Khiên: +120 Máu tối đa & tăng giáp bảo vệ.',
    ...
    },
    {
        ...
        description: 'Thêm Khiên vào đoàn xe. Nếu đã có Khiên: Tự động Hợp Nhất lên sao ⭐!',
    ...
    },
    {
        ...
        description: 'Thêm Phun Lửa vào đoàn xe. Nếu đã có: Tự động Hợp Nhất lên sao ⭐!',
    ...
    },
    {
        ...
        actionType: 'new_module',
        targetLabel: '⚡ Tháp Sét Tesla',
        description: 'Thêm Tesla phóng điện. Nếu đã có: Tự động Hợp Nhất lên sao ⭐!',
    ...
    },
    {
        ...
        description: 'Tăng +35% Tốc bắn cho tất cả vũ khí Năng Lượng (Tesla, v.v.).',
    ...
    },
    {
        ...
        effects: [{ type: 'add_attack_speed', value: 0.20 }],
    },
    {
        id: 'armor_plating',
    ...
    // ── Hiếm ──
    {
        ...
        effects: [{ type: 'add_burn_chance', value: 0.35, targetTag: 'projectile' }],
    },
    {
        id: 'shock_bullets',
        ...
        effects: [{ type: 'add_shock_chance', value: 0.30, targetTag: 'projectile' }],
    },
    {
        id: 'critical_hits',
        name: 'Đạn Chí Mạng',
        ...
        effects: [{ type: 'add_crit_chance', value: 0.20 }],
    },
    ...
    // ── Sử Thi ──
    {
        ...
        description: 'Quái vật chết sẽ phát nổ, gây sát thương lan cho quái xung quanh.',
...
export function getAvailableUpgrades(convoyTags: Set<string>): UpgradeDefinition[] {
