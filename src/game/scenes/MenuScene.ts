...
export class MenuScene extends Container implements Scene {
    ...
    constructor() {
        ...
        vignette.rect(0, 0, GAME_WIDTH, 220)
            .fill({ color: 0x000000, alpha: 0.35 });
        // Bottom shadow for Play Button
        vignette.rect(0, GAME_HEIGHT * 0.72, GAME_WIDTH, GAME_HEIGHT * 0.28)
        ...
        titleBadge.roundRect(-240, -68, 480, 136, 28)
            .fill(0xb45309);
        titleBadge.roundRect(-240, -74, 480, 136, 28)
            .fill(0xf59e0b)
            .stroke({ color: 0xffffff, width: 6 });
        titleBadge.roundRect(-220, -68, 440, 38, 14)
        ...
        subBadge.roundRect(-120, 48, 240, 36, 18)
            .fill(0x1e293b)
    ...
    private createMarth3Button(label: string): Container {
        ...
        shadow.roundRect(-w / 2, -h / 2 + 10, w, h, radius)
            .fill(0xc2410c);
        ...
        body.roundRect(-w / 2 + 16, -h / 2 + 6, w - 32, h * 0.38, 18)
    ...
    update(dt: number) {
        ...
        this.titleContainer.y = GAME_HEIGHT * 0.16 + Math.sin(this.animTime * 3) * 6;
