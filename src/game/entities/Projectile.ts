...
export type ProjectileType = 'bullet' | 'flame' | 'lightning' | 'rocket' | 'acid';
...
export class Projectile extends Container {
    ...
    private renderVisual() {
        ...
        if (this.projType === 'bullet') {
            ...
            this.gfx.roundRect(-12, -3, 24, 6, 3)
                .fill(tracerColor)
                .stroke({ color: 0xffffff, width: 1.5 });
            // Soft glow aura
            this.gfx.roundRect(-16, -5, 32, 10, 5)
            ...
            this.gfx.circle(0, 0, 6).fill(0xffffff).stroke({ color: 0x00e5ff, width: 2 });
            ...
            this.radius = 12;
            // Missile body
            this.gfx.roundRect(-14, -5, 28, 10, 4)
                .fill(0x334155)
                .stroke({ color: 0xffffff, width: 1.5 });
            // Red warhead
            ...
            this.gfx.circle(0, 0, 6).fill(0x86efac).stroke({ color: 0x15803d, width: 2 });
            // Toxic Bubbles
